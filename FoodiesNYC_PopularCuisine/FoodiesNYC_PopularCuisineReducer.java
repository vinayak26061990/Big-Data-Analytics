...
import java.util.*;
public class FoodiesNYC_PopularCuisineReducer extends Reducer<Text,Text,Text,Text> {
	@Override
	public void reduce(Text key,Iterable<Text> values,Context context) throws IOException,InterruptedException {
	        ...
	        if(total_rating_votes > 0 && total_votes > 0)
		{
			...
			context.write(new Text(key),new Text(Double.toString(total_weighted_rating) +"\t" +total_votes));
		}
